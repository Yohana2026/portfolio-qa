...
🔗 [Ver Web Portfolio QA](https://yohana2026.github.io/portfolio-qa/)
...
- Proyecto Supabase (requiere acceso): [Supabase Project](https://supabase.com/dashboard/project/aqnapdnyrpgkyhongsvs)  

## 🗄 API de Formulario
Se ha generado una API que permite agregar, editar, consultar y eliminar datos de la base de datos creada en supabase.
- URL API (requiere acceso): [Supabase API](https://aqnapdnyrpgkyhongsvs.supabase.co/rest/v1/form)  
- Documentación de la API: [Documentación API](https://yohana2026.github.io/portfolio-qa/apidoc.html) 
---
...
### Pruebas de API
- Colección en POSTMAN (requiere acceso): [POSTMAN Collection](https://gold-moon-942283.postman.co/workspace/form~1c72caa8-7154-41dc-91af-28dfd103d65d/collection/30133543-0510776b-47b8-475c-abcf-e68ba1b37ca0?action=share&source=copy-link&creator=30133543) 
